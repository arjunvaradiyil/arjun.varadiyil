...
export default function Footer() {
  return (
    <footer className='border-t-4 border-gray-900 bg-[#f5f2ea] py-10 text-gray-900 dark:border-white'>
      <div className='mx-auto max-w-7xl px-6 sm:px-8 md:px-16 lg:px-24'>
        ...
        <p className='mt-8 flex items-center justify-center gap-2 text-sm font-medium text-gray-700'>
          <span>Made with</span>
          <Heart className='h-4 w-4 shrink-0 fill-rose-500 text-rose-600' strokeWidth={2} aria-hidden />
          <a
            href={SITE_URL}
            className='font-syne font-bold tracking-tight text-gray-900 hover:underline'
            rel='noopener noreferrer'
          >
            Arjun Varadiyil
          </a>
