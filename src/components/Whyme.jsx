...
export default function WhyMe() {
  return (
    <section className="w-full bg-black text-white px-6 md:px-16 lg:px-24 py-24 overflow-hidden">
      <motion.div
      ...
      >
        ...
        <motion.p
          ...
          className="text-sm tracking-widest text-lime-400 mb-6"
        >
          (WHY ME)
        </motion.p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <motion.h2
            variants={itemVariants}
            className="font-anton font-bold uppercase tracking-wide text-[48px] sm:text-[64px] md:text-[140px] leading-[1] text-[#cacaca]"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-[#8f8f8f] text-base md:text-lg leading-relaxed max-w-xl"
          >
