    ...
    <section id="education" ref={sectionRef} className="relative py-24 sm:py-32 bg-gray-900/50 backdrop-blur-sm overflow-hidden border-y border-slate-800/50 scroll-mt-24">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold leading-7 text-amber-400">Education</p>
          <h2 id="education-heading" className="mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl">My Education</h2>
        </div>
