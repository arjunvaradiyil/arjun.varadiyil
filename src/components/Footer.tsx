  ...
  return (
    <footer className="relative z-10 border-t border-white/20 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-4 flex justify-center space-x-6">
            ...
            <a href="https://www.instagram.com/arjunvardiyil/?utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white"><Instagram /></a>
            <a href="https://wa.me/919946642065" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white"><WhatsappIcon /></a>
      ...
      <div className="mt-8 border-t border-white/10 pt-8 text-center text-gray-400 text-sm">
        © 2025 <strong className="font-semibold text-gray-300 text-white">Arjun Varadiyil</strong>. All rights reserved. | Built with Next.js & Tailwind CSS
      </div>
    </footer>
  );
} 