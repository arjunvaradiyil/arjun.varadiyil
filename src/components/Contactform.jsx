      ...
      <div className="relative z-10 flex flex-col md:flex-row w-11/12 lg:w-9/12 mx-auto gap-8">
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 pr-0 md:pr-12 text-center md:text-left">
          <h1 className="bebas-neue-regular text-4xl sm:text-4xl md:text-9xl lg:text-10xl font-extrabold leading-tight">
            Ready? <br />
            <span className="text-[#34ebd2]">Let's Talk</span>
          </h1>
        </div>
        ...
        <div className="w-full md:w-1/2 bg-[#110f0f] border border-[#747373] rounded-2xl p-6 sm:p-8 shadow-lg">
          ...
          {step === 1 && (
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-[#34ebd2] text-black font-bold py-2.5 sm:py-3 rounded-lg hover:bg-cyan-400 transition"
              >
                Continue
              </button>
            </form>
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm">
                ...
                <p>
                  I accept the{" "}
                  <a href="#" className="text-[#34ebd2] underline">
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-2 sm:gap-4">
                ...
                <button
                  ...
                  className="w-full sm:w-1/2 bg-[#34ebd2] text-black font-bold py-2.5 sm:py-3 rounded-lg hover:bg-cyan-400 transition"
                >
                  Submit
                </button>
              </div>
